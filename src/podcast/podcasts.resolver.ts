...
export class PodcastsResolver {
    ...
    @Query((returns) => GetAllPodcastsOutput)
    @Role(["Host"])
    getHostPodcasts(@AuthUser() user: User): Promise<GetAllPodcastsOutput> {
        return this.podcastsService.getHostPodcasts(user);
    }

    @Query((returns) => GetPodcastsPagenationOutput)
    getPodcastsPagenation(
        @Args("input") getPodcastsPagenationInput: GetPodcastsPagenationInput
    ): Promise<GetPodcastsPagenationOutput> {
        return this.podcastsService.getPodcastsPagenation(
            getPodcastsPagenationInput
        );
    }

    @Query((returns) => GetPodcastsPagenationOutput)
    getPodcastsCategoryPagenation(
        @Args("input")
        getPodcastsPagenationInput: GetPodcastsCategoryPagenationInput
    ): Promise<GetPodcastsPagenationOutput> {
        return this.podcastsService.getPodcastsCategoryPagenation(
            getPodcastsPagenationInput
        );
    }
}
